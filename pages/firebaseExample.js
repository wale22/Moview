...
const data= query(colRef, where('key','==', 'constraint'), orderBy('key', 'order(ascending or descending)'))



// using time to track in firebase
serverTimestamp() // this function returns the curent time 
